...
Обучение включает в себя изучение следующих **[тем]({{site.contenturl}})** и проходит с использованием платформы **[learn.epam.com](https://learn.epam.com/){:target="_blank"}**.  
...
---------------------
Основная цель данного **онлайн курса** заключается в подготовке кандидатов к успешному прохождению входного собеседования на **внутренние курсы** Java в **[Ижевский](https://www.youtube.com/watch?v=8z2ZWhGYU8A){:target="_blank"}** офис компании **[EPAM](https://www.epam.com){:target="_blank"}**.
...
---------------------
Каждый студент самостоятельно выполняет модули и запускает тесты для проверки заданий. Финальный модуль представляет из себя комплексный проект, использующий наработки всего курса. Данный проект проверяется ментором и является главным критерием успешного завершения обучения.
...
---------------------
В случае, если вы уверены в своих знаниях по Java и понимаете, что у вас нет необходимости в прохождении части базовых модулей, можете их пропустить.
